...
if __name__ == '__main__':
    params = {
        "model_path": '/home/jing/ros_project/src/robot_learning/object_detect/scripts/pth/Epoch_053_Loss_5.4068.pth',
...
#     if use_attention:
#         params = {
#             "model_path": 'chk/ch13/Epoch_053_Loss_5.4068.pth',
#             "anchors_path": 'work_dir/yolo_anchors_coco.txt',
#             "classes_path":
#             'work_dir/my_classes.txt',
#             "model_image_size": (416, 416, 3),
#             "confidence": 0.1, #0.1, # 0.6,
#             "cuda": False
#         }
...
#             "anchors_path": 'work_dir/yolo_anchors_coco.txt',
#             "classes_path":
#             'work_dir/coco_classes.txt',
#             "model_image_size": (416, 416, 3),
#             "confidence": 0.6, #0.1, # 0.6,
#             "cuda": False
#         } 
...
#     image_src = cv2.imread('inputs/000000370711.jpg')
#     # image_src = cv2.imread('inputs/cat_pc_mouse.jpeg')
#     boxes = model.detect_image(image_src)
#     # if boxes is None:
#     #     pass
#     # else:
#     img = plot_boxes_cv2(image_src, boxes, savename='outputs/test/370711_11_30.jpg', class_names=class_names)
#     # print(img)
#     # img = img[0]
#     plt.imshow(img)
#     plt.show()