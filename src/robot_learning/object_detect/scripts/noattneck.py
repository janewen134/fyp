...
class YoloBody(nn.Module):
    def __init__(self, num_anchors, num_classes):
        ...
        # if use_attention:
        #     self.attention2 = CoordAtt(inp=128, oup=128)
        ...
        # if use_attention:
        #     self.attention3 = CoordAtt(inp=256, oup=256)
        ...
        # if use_attention:
        #     self.attention4 = CoordAtt(inp=512, oup=512)
    ...
    def forward(self, x):
        ...
        # if use_attention:
        #     P4_upsample = self.attention2(P4_upsample)
        ...
        # if use_attention:
        #     P3_downsample = self.attention3(P3_downsample)
        ...
        # if use_attention:
        #     P4_downsample = self.attention4(P4_downsample)
